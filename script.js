  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      for (let i = 0; i < formElements.length; i++) {
        ...
        if (field.hasAttribute('required') && field.type !== 'submit') {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "HOMLAND CONSRIGE משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c3ddea04-796e-47c3-bfb9-3c7657640b4b',
                    name: data.name || '',
                    email: data.email || '',
